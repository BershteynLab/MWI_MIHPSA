...
ingest_xlsm_filename = os.path.join('Data', 'calibration_ingest_form_Malawi_3_node_DTC.xlsm')
...
config_templates = []
config_filename = os.path.join(template_files_dir, 'config_transmission.json')
...
demographics_filenames = [
    os.path.join(static_files_dir, 'Demographics_Malawi.json'),
    os.path.join(template_files_dir, 'PFA_Overlay_Malawi.json'),
    os.path.join(template_files_dir, 'Accessibility_and_Risk_IP_Overlay_Malawi.json'),
    os.path.join(template_files_dir, 'Risk_Assortivity_Overlay_Malawi.json')
]
