...
```{r Load Report Data}
input_path = "/gpfs/scratch/citrod01/experiments/Malawi/Baseline-campaign_Malawi_20220422_recalib-mort___2022_09_05_17_05_30_242956"
...
sim.results.pop.scaling$sim.id.ix <- 1:25
...
write_excel_csv(baseline.comp.data, "mort_baseline_comp_data.csv")
```
...
#mort.data.means %>% View()

write_excel_csv(mort.data.means, 'mihpsa_mortality_table.csv')
