...
```{r Load Report Data}
input_path = "/gpfs/scratch/citrod01/experiments/Malawi/Baseline-campaign_Malawi_20220422_recalib-transmission___2022_09_15_17_26_45_584971"
...
fun.onart.under6mo.reinit <- function(tr.data, art.report, year.age.sex){
  ...
  p2 <- left_join(year.age.sex, p2, by = c("Tr_year_binned", "Age_bin", "Gender")) %>% 
